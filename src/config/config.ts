...
class Config {
  ...
  digiSpaceEndpoint: string;
  digiSpaceAccessKeyId: string;
  digiSpaceSecretAccessKey: string;
  ...
  constructor() {
    ...
    this.carfaxLogin = process.env.CARFAX_LOGIN
    this.carfaxPassword = process.env.CARFAX_PASSWORD
    this.userSdkSecret = process.env.USER_SDK_SECRET
    this.carfaxApiUrl = process.env.CARFAX_API_URL
